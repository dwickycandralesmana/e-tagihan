...
<div class="page-body">
    <div class="container-xl">
        <div class="card">
            ...
            <form action="{{ route('jenis-pembayaran.profile_update') }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                <label for="name" class="form-label fw-bold">Nama Jenis Pembayaran</label>
