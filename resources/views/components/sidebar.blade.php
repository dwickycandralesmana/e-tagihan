<aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
    <div class="container-fluid">
        ...
        <h1 class="navbar-brand navbar-brand-autodark">
            <a href=".">
                <img src="{{ asset('assets/img/sidebar-logo.png') }}" width="130" height="60" alt="Tabler"
                    class="navbar-brand-image" style="filter: invert(0); height: 3rem !important;">
            </a>
        </h1>
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item" id="liTagihan">
                ...
                <li class="nav-item" id="liPembayaran">
                ...
                <li class="nav-item dropdown" id="liLaporan">
                    <a class="nav-link dropdown-toggle" href="#navbar-form" data-bs-toggle="dropdown"
                        data-bs-auto-close="false" role="button" aria-expanded="false" id="liDropdownLaporan">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round"
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="{{ route('laporan.siswa') }}" id="liLaporanKelas"> Tagihan per Kelas </a>
                    </div>
                </li>
                @if($auth->type == 'admin')
                <li class="nav-item" id="liUser">
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                    ...
                    <div class="d-none d-xl-block ps-2">
                        <div>{{ $auth->name }}</div>
                        <div class="mt-1 small text-muted">{{ ucfirst($auth->type) }}</div>
                    </div>
                </a>
