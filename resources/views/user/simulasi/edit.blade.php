...
<div class="page-body">
    <div class="container-xl">
        <div class="card">
            ...
            <form action="{{ route('simulasi.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 col-sm-12">
                            <div class="mb-3">
                                <label for="name" class="form-label fw-bold">Nama Simulasi</label>
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('simulasi.index') }}" class="btn btn-secondary"><i class="fas fa-times"></i> Batal</a>
                </div>
            </form>
        </div>
    </div>
