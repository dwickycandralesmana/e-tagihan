...
class ReportController extends BaseController
{
    ...
    public function potonganData(Request $request)
    {
        ...
        return DataTables::of($data)
            ->addIndexColumn()
            ->editColumn('tanggal_pembayaran', function ($row) {
                return Carbon::parse($row->tanggal_pembayaran)->format('j F Y');
            })
    ...
    public function potonganExport(Request $request)
    {
        ...
        $fileName = date('YmdHis') . ' Potongan.xlsx';
    ...
    public function pembayaran()
    {
        ...
        return view('admin.report.pembayaran', $this->data);
    }
    ...
    public function pembayaranData(Request $request)
    {
        ...
        return DataTables::of($data)
            ...
            ->editColumn('bayar', function ($row) {
                return formatRp($row->bayar);
            })
            ->editColumn('jumlah', function ($row) {
                return formatRp($row->jumlah);
            })
            ->editColumn('potongan', function ($row) {
                return formatRp($row->potongan);
            })
